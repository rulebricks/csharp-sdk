...
[JsonConverter(typeof(ContextBaseOnSchemaMismatch.ContextBaseOnSchemaMismatchSerializer))]
[Serializable]
public readonly record struct ContextBaseOnSchemaMismatch : IStringEnum
{
    ...
    internal class ContextBaseOnSchemaMismatchSerializer
        : JsonConverter<ContextBaseOnSchemaMismatch>
    {
        public override ContextBaseOnSchemaMismatch Read(
        ...
        )
        {
            ...
            return new ContextBaseOnSchemaMismatch(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ContextBaseOnSchemaMismatch value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ContextBaseOnSchemaMismatch ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
