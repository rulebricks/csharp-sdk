...
namespace RulebricksApi.Assets.Contexts;
...
public partial class RelationshipsClient : IRelationshipsClient
{
    ...
    /// </summary>
    /// <example><code>
    /// await client.Assets.Contexts.Relationships.ListAsync(
    ...
    /// </summary>
    /// <example><code>
    /// await client.Assets.Contexts.Relationships.CreateAsync(
    ...
    /// </summary>
    /// <example><code>
    /// await client.Assets.Contexts.Relationships.DeleteAsync(
