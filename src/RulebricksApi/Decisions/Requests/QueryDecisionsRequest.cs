...
public record QueryDecisionsRequest
{
    ...
    /// </summary>
    [JsonIgnore]
    public QueryDecisionsRequestIncludeTraces? IncludeTraces { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public QueryDecisionsRequestSort? Sort { get; set; }

    /// <summary>
    /// Sort direction. Defaults to `desc`.
    /// </summary>
    [JsonIgnore]
    public QueryDecisionsRequestOrder? Order { get; set; }
