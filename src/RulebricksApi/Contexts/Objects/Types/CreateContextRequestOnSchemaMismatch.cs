...
[JsonConverter(
    typeof(CreateContextRequestOnSchemaMismatch.CreateContextRequestOnSchemaMismatchSerializer)
)]
[Serializable]
public readonly record struct CreateContextRequestOnSchemaMismatch : IStringEnum
{
    ...
    internal class CreateContextRequestOnSchemaMismatchSerializer
        : JsonConverter<CreateContextRequestOnSchemaMismatch>
    {
        public override CreateContextRequestOnSchemaMismatch Read(
        ...
        )
        {
            ...
            return new CreateContextRequestOnSchemaMismatch(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            CreateContextRequestOnSchemaMismatch value,
            JsonSerializerOptions options
        )
        {
        ...
        public override CreateContextRequestOnSchemaMismatch ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
