...
{
    public static readonly UpdateContextRequestOnSchemaMismatch Ignore = new(Values.Ignore);

    public static readonly UpdateContextRequestOnSchemaMismatch Reject = new(Values.Reject);

    public static readonly UpdateContextRequestOnSchemaMismatch Store = new(Values.Store);

    public UpdateContextRequestOnSchemaMismatch(string value)
    {
        Value = value;
    }
    ...
    /// </summary>
    public static UpdateContextRequestOnSchemaMismatch FromCustom(string value)
    {
        return new UpdateContextRequestOnSchemaMismatch(value);
    }
    ...
    public static bool operator ==(UpdateContextRequestOnSchemaMismatch value1, string value2) =>
        value1.Value.Equals(value2);

    public static bool operator !=(UpdateContextRequestOnSchemaMismatch value1, string value2) =>
        !value1.Value.Equals(value2);

    public static explicit operator string(UpdateContextRequestOnSchemaMismatch value) =>
        value.Value;
